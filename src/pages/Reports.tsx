            ...
            <div className="flex flex-col md:flex-row md:justify-between space-y-4 md:space-y-0 md:space-x-4 mb-4">
                <div className="flex items-center space-x-2">
                    ...
                    <input
                        ...
                        className="border rounded-md p-2"
                    />
                    <button className="flex items-center bg-blue-500 text-white px-4 py-1 rounded-md hover:bg-blue-600 transition duration-300">
                        Apply
                    </button>
                </div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="bg-blue-100 p-4 rounded-md">
                            ...
                            <p className="text-2xl font-bold">390 hours</p>
                        </div>
                        ...
                        <table className="w-full text-left">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td className="p-3">Machine A</td>
                                    <td className="p-3">Unusual noise</td>
                                    <td className="p-3">
                                ...
                                <tr>
                                    <td className="p-3">2024-07-12</td>
                                    <td className="p-3">Machine C</td>
                                    <td className="p-3">Regular checkup</td>
                                    <td className="p-3">
                                ...
                                <tr>
                                    ...
                                    <td className="p-3">Machine B</td>
                                    <td className="p-3">Oil leak</td>
                                    <td className="p-3">
                                        <span className="bg-green-100 text-green-800 px-2 py-1 rounded-full text-xs">
                                            Completed
                                        </span>
